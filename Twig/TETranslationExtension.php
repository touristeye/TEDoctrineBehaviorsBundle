...
namespace TE\DoctrineBehaviorsBundle\Twig;
...
class TETranslationExtension extends \Twig_Extension
{
    ...
    {
        if (!is_a($entity, 'TE\DoctrineBehaviorsBundle\Doctrine\Base\Translatable')) {
            throw new \Twig_Error_Runtime('The "translate" filter can be applied only to an entity that extends "TE\DoctrineBehaviorsBundle\Doctrine\Base\Translatable"');
        }
        // sf 2.1
        if ($lang == null) {
